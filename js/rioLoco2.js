...
function growDiv(){
  jQuery(this).append('<div class="myButton" id="shedButton">Watershed</div>').animate({height:"100px", width:"150px"}, "fast");
...
function shrinkDiv(){
  jQuery(this).html("<p>Layers...</p>").animate({height:"20px", width:"70px"}, "fast");
}
dojo.ready(init);